...
public readonly struct StructVariant<T1, T2, T3, T4, T5, T6, T7, T8> : IStructVariant
{
    ...
    public StructVariant(T8 item8) : this(true)
    {
        _item8 = item8;
    ...
    public static implicit operator StructVariant<T1, T2, T3, T4, T5, T6, T7, T8>(T1 value)
    {
        return new StructVariant<T1, T2, T3, T4, T5, T6, T7, T8>(value);
    }

    public static implicit operator StructVariant<T1, T2, T3, T4, T5, T6, T7, T8>(T2 value)
    {
        return new StructVariant<T1, T2, T3, T4, T5, T6, T7, T8>(value);
    }

    public static implicit operator StructVariant<T1, T2, T3, T4, T5, T6, T7, T8>(T3 value)
    {
        return new StructVariant<T1, T2, T3, T4, T5, T6, T7, T8>(value);
    }

    public static implicit operator StructVariant<T1, T2, T3, T4, T5, T6, T7, T8>(T4 value)
    {
        return new StructVariant<T1, T2, T3, T4, T5, T6, T7, T8>(value);
    }

    public static implicit operator StructVariant<T1, T2, T3, T4, T5, T6, T7, T8>(T5 value)
    {
        return new StructVariant<T1, T2, T3, T4, T5, T6, T7, T8>(value);
    }

    public static implicit operator StructVariant<T1, T2, T3, T4, T5, T6, T7, T8>(T6 value)
    {
        return new StructVariant<T1, T2, T3, T4, T5, T6, T7, T8>(value);
    }

    public static implicit operator StructVariant<T1, T2, T3, T4, T5, T6, T7, T8>(T7 value)
    {
        return new StructVariant<T1, T2, T3, T4, T5, T6, T7, T8>(value);
    }

    public static implicit operator StructVariant<T1, T2, T3, T4, T5, T6, T7, T8>(T8 value)
    {
        return new StructVariant<T1, T2, T3, T4, T5, T6, T7, T8>(value);
    }
    ...
    /// <returns></returns>
    public static T Get<T>(StructVariant<T1, T2, T3, T4, T5, T6, T7, T8> variant)
    {
    ...
    /// <typeparam name="T">Requested type.</typeparam>
    /// <returns></returns>
    public static bool TryGet<T>(StructVariant<T1, T2, T3, T4, T5, T6, T7, T8> variant, out T? value)
    {
    ...
    public bool TryGet<T>(out T? value)
    {
        ...
        if (StructVariant.TestItem(_item7, SetItems.Item7 == _setItem, out value)) return true;
        return StructVariant.TestItem(_item8, SetItems.Item8 == _setItem, out value);
    }
