...
public readonly struct StructVariant<T1, T2, T3> : IStructVariant
{
    ...
    public static implicit operator StructVariant<T1, T2, T3>(T1 value)
    {
        return new StructVariant<T1, T2, T3>(value);
    }

    public static implicit operator StructVariant<T1, T2, T3>(T2 value)
    {
        return new StructVariant<T1, T2, T3>(value);
    }

    public static implicit operator StructVariant<T1, T2, T3>(T3 value)
    {
        return new StructVariant<T1, T2, T3>(value);
    }
    ...
    /// <returns></returns>
    public static T Get<T>(StructVariant<T1, T2, T3> variant)
    {
    ...
    /// <typeparam name="T">Requested type.</typeparam>
    /// <returns></returns>
    public static bool TryGet<T>(StructVariant<T1, T2, T3> variant, out T? value)
    {
    ...
    public bool TryGet<T>(out T? value)
    {
        ...
        return StructVariant.TestItem(_item3, SetItems.Item3 == _setItem, out value);
    }
