...
public readonly struct StructVariant<T1, T2, T3, T4, T5> : IStructVariant
{
    ...
    public static implicit operator StructVariant<T1, T2, T3, T4, T5>(T1 value)
    {
        return new StructVariant<T1, T2, T3, T4, T5>(value);
    }

    public static implicit operator StructVariant<T1, T2, T3, T4, T5>(T2 value)
    {
        return new StructVariant<T1, T2, T3, T4, T5>(value);
    }

    public static implicit operator StructVariant<T1, T2, T3, T4, T5>(T3 value)
    {
        return new StructVariant<T1, T2, T3, T4, T5>(value);
    }

    public static implicit operator StructVariant<T1, T2, T3, T4, T5>(T4 value)
    {
        return new StructVariant<T1, T2, T3, T4, T5>(value);
    }

    public static implicit operator StructVariant<T1, T2, T3, T4, T5>(T5 value)
    {
        return new StructVariant<T1, T2, T3, T4, T5>(value);
    }
    ...
    /// <returns></returns>
    public static T Get<T>(StructVariant<T1, T2, T3, T4, T5> variant)
    {
    ...
    /// <typeparam name="T">Requested type.</typeparam>
    /// <returns></returns>
    public static bool TryGet<T>(StructVariant<T1, T2, T3, T4, T5> variant, out T? value)
    {
    ...
    public bool TryGet<T>(out T? value)
    {
        ...
        return StructVariant.TestItem(_item5, SetItems.Item5 == _setItem, out value);
    }
