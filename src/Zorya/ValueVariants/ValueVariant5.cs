...
public readonly struct ValueVariant<T1, T2, T3, T4, T5> : IValueVariant,
    IEquatable<ValueVariant<T1, T2, T3, T4, T5>>
{
    ...
    public bool Equals(ValueVariant<T1, T2, T3, T4, T5> other)
    {
    ...
    {
        return obj is ValueVariant<T1, T2, T3, T4, T5> other && Equals(other);
    }

    public override int GetHashCode()
    {
        return HashCode.Combine((int)_setItem, _item1, _item2, _item3, _item4, _item5);
    }

    public static bool operator ==(ValueVariant<T1, T2, T3, T4, T5> left, ValueVariant<T1, T2, T3, T4, T5> right)
    {
