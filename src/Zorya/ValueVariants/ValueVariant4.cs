...
public readonly struct ValueVariant<T1, T2, T3, T4> : IValueVariant,
    IEquatable<ValueVariant<T1, T2, T3, T4>>
{
    ...
    public static implicit operator ValueVariant<T1, T2, T3, T4>(T1 value)
    {
        if (value is null) return default;
        return new ValueVariant<T1, T2, T3, T4>(value);
    }

    public static implicit operator ValueVariant<T1, T2, T3, T4>(T2 value)
    {
        if (value is null) return default;
        return new ValueVariant<T1, T2, T3, T4>(value);
    }

    public static implicit operator ValueVariant<T1, T2, T3, T4>(T3 value)
    {
        if (value is null) return default;
        return new ValueVariant<T1, T2, T3, T4>(value);
    }

    public static implicit operator ValueVariant<T1, T2, T3, T4>(T4 value)
    {
        if (value is null) return default;
        return new ValueVariant<T1, T2, T3, T4>(value);
    }
    ...
    /// <returns></returns>
    public static T Get<T>(ValueVariant<T1, T2, T3, T4> variant)
    {
    ...
    /// <typeparam name="T">Requested type.</typeparam>
    /// <returns></returns>
    public static bool TryGet<T>(ValueVariant<T1, T2, T3, T4> variant, out T? value)
    {
    ...
    public bool TryGet<T>(out T? value)
    {
        ...
        return ValueVariant.TestItem(_item4, SetItems.Item4 == _setItem, out value);
    }
    ...
    public bool Equals(ValueVariant<T1, T2, T3, T4> other)
    {
    ...
    {
        return obj is ValueVariant<T1, T2, T3, T4> other && Equals(other);
    }

    public override int GetHashCode()
    {
        return HashCode.Combine((int) _setItem, _item1, _item2, _item3, _item4);
    }

    public static bool operator ==(ValueVariant<T1, T2, T3, T4> left, ValueVariant<T1, T2, T3, T4> right)
    {
