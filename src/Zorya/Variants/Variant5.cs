...
public sealed class Variant<T1, T2, T3, T4, T5> : Variant, IVariant,
    IEquatable<Variant<T1, T2, T3, T4, T5>>
{
    ...
    public override bool Equals(object? obj)
    {
        ...
        return Equals((Variant<T1, T2, T3, T4, T5>) obj);
    }
    ...
    public static bool operator ==(Variant<T1, T2, T3, T4, T5>? left, Variant<T1, T2, T3, T4, T5>? right)
    {
